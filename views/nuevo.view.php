...
<div class="contenedor">
	<div class="post">
	    <article>
	        ...
	        <form class="formulario" method="post" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>"> <!-- el enctype hay que ponerlo porque tambien se envian imágenes-->
